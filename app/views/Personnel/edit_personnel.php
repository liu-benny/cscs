...
<form method="post" action="<?= URLROOT; ?>/Personnel/edit_personnel/<?= $data['personnel']->personnel_id ?>">
    <h3>Edit the Personnel information <button type="button" class="btn btn-warning" onclick="window.location.href='<?= URLROOT; ?>/Personnel/change_location/<?= $data['personnel']->personnel_id ?>'">
        ...
        <label for="first_name_input" class="col-sm-2 col-form-label">First Name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="first_name_input" name="first_name" value="<?= $data['personnel']->first_name ?> " required>
            </div>
        </div>
        ...
        <label for="last_name_input" class="col-sm-2 col-form-label">Last Name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="last_name_input" name="last_name" value="<?= $data['personnel']->last_name ?> " required>
            </div>
        </div>
        ...
        <label for="date_of_birth_input" class="col-sm-2 col-form-label">Date of Birth</label>
            <div class="col-sm-4">
                <input type="date" class="form-control" id="date_of_birth_input" name="date_of_birth" value="<?= $data['personnel']->date_of_birth ?>" required>
            </div>
        </div>
        ...
        <label for="ssn_input" class="col-sm-2 col-form-label">SSN</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" id="ssn_input" name="ssn" value="<?= $data['personnel']->ssn ?>" required>
            </div>
        </div>
        ...
        <label for="medicare_input" class="col-sm-2 col-form-label">Medicare</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="medicare_input" name="medicare_number" value="<?= $data['personnel']->medicare_number ?>" required>
            </div>
        </div>
        ...
        <label for="phone_number_input" class="col-sm-2 col-form-label">Phone Number</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="phone_number_input" name="phone_number" value="<?= $data['personnel']->phone_number ?>" required>
            </div>
        </div>
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="address_input" name="address" value="<?= $data['personnel']->address ?>" required>
        </div>
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="city_input" name="city" value="<?= $data['personnel']->city ?>" required>
    </div>
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" id="postal_code_input" name="postal_code" value="<?= $data['personnel']->postal_code ?>" required>
    </div>
  </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
        <input type="email" class="form-control" id="email_input" name="email" value="<?= $data['personnel']->email ?>" required>
        </div>
    </div>
    <div class="form-group row">
    <label for="role_input" class="col-sm-2 col-form-label">Role</label>
        <div class="col-sm-4">
            <select id="role_input" class="form-control" name="personnel_role" required>
    ...
    <label for="mandate_input" class="col-sm-2 col-form-label">Mandate</label>
        <div class="col-sm-4">
            <select id="mandate_input" class="form-control" name="mandate" required>
