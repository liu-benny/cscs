...
<form method="post" action="<?= URLROOT; ?>/ClubMember/add_clubmember">
    <h3>New Club Member</h3>
    ...
    <div class="col-sm-4"> 
        ...
        <label for="height_input" class="col-sm-2 col-form-label">Height (cm)</label>
            <div class="col-sm-4">
                <input type="number" class="form-control" id="height_input" name="height_cm" placeholder="Height (cm)" required>
            </div>
        </div>
        ...
        <label for="weight_input" class="col-sm-2 col-form-label">Weight (kg)</label>
            <div class="col-sm-4">
                <input type="number" class="form-control" id="weight_input" name="weight_kg" placeholder="Weight (kg)" required>
            </div>
        </div>
